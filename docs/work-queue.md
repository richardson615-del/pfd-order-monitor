...
| # | Item | Brief | Status |
|---|---|---|---|
| 0 | Enable auto-merge on the open PRs in this order: #62, then #63 (retarget base to main after #62 merges), then #64 | — | claimed (2026-09-16) |
| 1 | E3 follow-up `feat/poll-first`: Realtime opt-in (env flag, default off), incremental poll "changed since last sync" | docs/scale-500.md §6 | PR #65 |
